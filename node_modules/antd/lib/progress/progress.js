        ...
        value: function render() {
            ...
            if (showInfo) {
                ...
                if (progressStatus === 'exception') {
                    text = format ? textFormatter(validProgress(percent)) : React.createElement(_icon2['default'], { type: 'cross' + iconType });
                } else if (progressStatus === 'success') {
                    text = format ? textFormatter(validProgress(percent)) : React.createElement(_icon2['default'], { type: 'check' + iconType });
                } else {
